...
export const NE_ASPECT_INTRO: IntroEntry[] = l0.intro.map((entry, i) => ({
  ...entry,
  id: `ne-intro-${i + 1}`
}))

export const NE_LEVEL_0_CORE: Script[] = l0.scripts
export const NE_LEVEL_0_COMPLETE: CompleteEntry = l0.complete ?? { text: 'Уровень пройден.' }

export const NE_LEVEL_1_CORE: Script[] = l1.scripts
export const NE_LEVEL_1_COMPLETE: CompleteEntry = l1.complete ?? { text: 'Уровень пройден.' }

export const NE_LEVEL_2_CORE: Script[] = l2.scripts
export const NE_LEVEL_2_COMPLETE: CompleteEntry = l2.complete ?? { text: 'Уровень пройден.' }

export const NE_LEVEL_3_CORE: Script[] = l3.scripts
export const NE_LEVEL_3_COMPLETE: CompleteEntry = l3.complete ?? { text: 'Уровень пройден.' }
