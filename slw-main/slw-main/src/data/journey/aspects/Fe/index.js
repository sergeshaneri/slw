...
export const FE_ASPECT_INTRO = l0.intro.map((entry, i) => ({
  ...entry,
  id: `che-intro-${i + 1}`
}))
...
export const FE_LEVEL_0_CORE = l0.scripts
export const FE_LEVEL_0_COMPLETE = l0.complete ?? { text: 'Уровень пройден.' }

export const FE_LEVEL_1_CORE = l1.scripts
export const FE_LEVEL_1_COMPLETE = l1.complete ?? { text: 'Уровень пройден.' }

export const FE_LEVEL_2_CORE = l2.scripts
export const FE_LEVEL_2_COMPLETE = l2.complete ?? { text: 'Уровень пройден.' }

export const FE_LEVEL_3_CORE = l3.scripts
export const FE_LEVEL_3_COMPLETE = l3.complete ?? { text: 'Уровень пройден.' }
