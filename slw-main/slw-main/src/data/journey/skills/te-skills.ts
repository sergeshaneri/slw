// Сборка всего, что относится к навыкам ЧЛ.
//
// Источники:
//   - `te-tree.js` — структура архетипов (4) + 4 общих базовых сквозным слоем.
//   - `te-surveys.md` — текст 62 анкет (4 общих + 14 + 14 + 19 + 11 = 62).
//   - `parseSurveys.js` — общий парсер (БС/ЧИ/ЧЛ).
//
