...
// `ne-surveys.md`) → skill id. Используется парсером `parseSurveys.js`.
//
...
export const SKILL_BY_RUS_NAME = {
  ...
  'Зазор между стимулом и реакцией (mindfulness)': 'mindfulness',

  // Sage
  'Чтение программы объекта': 'read-program',
  'Распознавание паттернов': 'patterns',
  'Видение универсального в частном': 'universal-in-part',
  'Смыслообразование (sense-making)': 'sense-making',
  'Схлопывание парадоксов': 'paradox',
  'Построение ментальных моделей': 'mental-models',
  'Чтение невысказанного': 'read-unsaid',

  // Pioneer
  'Открывание вариантов': 'variants',
  'Мысленные эксперименты («а что, если…»)': 'thought-experiments',
  'Соединение и сплав разнородного': 'synthesis',
  'Совершать открытия': 'discovery',
  'Игра в неизведанном': 'play',
  'Серендипность и продуктивное «незнание»': 'serendipity',
  'Работа с информационным потоком': 'info-flow',

  // Catalyst
  'Сильные вопросы и сократический диалог': 'socratic',
  'Удержание паузы для прорыва другого': 'holding-pause',
  'Видение и зажигание сильных сторон': 'strengths',
  'Распаковка чужого замысла': 'unpacking',
  'Запуск движения через видение': 'vision-launch',
  'Создание поля для проявления других': 'field',
  'Искусство переводить и упрощать': 'translation',
  'Чтение чужого материала': 'read-others',
  'Позитивный рефрейминг': 'reframing',
  'Эксперимент на себе (как метод запуска изменений)': 'self-experiment',

  // Visionary
  'Метапозиция и наблюдающее Я': 'meta-position',
  'Удержание картины и управление масштабом': 'big-picture',
  'Работа с возможным будущим': 'futures',
  'Удержание видения во времени': 'holding-vision',
  'Видение потенциала и новых возможностей': 'potential',
  'Следование за интересом (внутренний зов)': 'inner-call',
  'Чувствование лучшего шага сейчас (аффорданс)': 'affordance',
  'Управление состоянием для рождения идей': 'flow-incubation',
  'Различение «ещё не созревшего»': 'ripening',
}
